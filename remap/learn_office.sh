...
do
    sem --id office --bg --jobs 40 "nohup python experiment.py --eq_samples 1000 --domain office --task t$i --trial $j  1> /dev/null 2> logs/office_world_abr_1000_t$i.err.$j"
    sem --id office --bg --jobs 40 "nohup python experiment.py --eq_samples 5000 --domain office --task t$i --trial $j  1> /dev/null 2> logs/office_world_abr_5000_t$i.err.$j"
done
done
